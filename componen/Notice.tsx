...
export default function Notice(){
    return(
        <div className="w-full flex bg-white p[1vh] gap-5 lg:justify-center">
            ...
            <Travel iconSrc="https://static.airasia.com/cosmos/images/carouselwidget/id/2025/Widget-Early-Flex-ID.jpg" h1="Kelamaan nunggu di bandara?" p="erbang duluan pakai EARLY FLEX"/>                                                
        </div>
    );
}